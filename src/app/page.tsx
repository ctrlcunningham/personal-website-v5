...
export default function Home() {
	return (
		<>
			...
			<div className={`flex lg:flex-row sm:flex-col gap-4 justify-evenly items-center text-center ${noto_sans.className}`}>
				<div className="border-1 border-ctp-sapphire rounded-xl w-fit p-6 mt-4">
				...
				<div className="border-1 border-ctp-flamingo rounded-xl w-fit p-6 mt-4">
				...
				<div className="border-1 border-ctp-subtext0 rounded-xl w-fit p-6 mt-4">
