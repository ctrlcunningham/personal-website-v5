		...
		<>
			...
			<div className={`flex gap-4 justify-evenly text-center ${noto_sans.className}`}>
				<div className="border-1 border-ctp-sapphire rounded-xl w-fit p-4 mt-4">
					<h2 className={`text-xl mb-1 font-semibold text-ctp-sky ${noto_sans_light.className}`}>projects i'm most proud of</h2>
					<ul className="ml-4">
				...
				<div className="border-1 border-ctp-flamingo rounded-xl w-fit p-4 mt-4">
					<h2 className={`text-xl mb-1 font-semibold text-ctp-flamingo ${noto_sans_light.className}`}>frameworks i've worked with</h2>
					<ul className="ml-4">
				...
				<div className="border-1 border-ctp-subtext0 rounded-xl w-fit p-4 mt-4">
					<h2 className={`text-xl font-semibold ${noto_sans_light.className}`}>notable systems i'm experienced in</h2>
					<ul>
						<li>nixos</li>
						<li>proxmox</li>
						<li>docker</li>
